...
//        cm = new PoolingHttpClientConnectionManager(getRegistry());
    ...
    /**
     * 发送 HTTPS POST 请求
     * 使用指定证书以及秘密吗，请求头为"application/xml; charset=UTF-8"
     * @param url
     * @param param
     * @param path
     * @param password
...
//        String s = StringEscapeUtils.unescapeJava(result);
    ...
    private static SSLConnectionSocketFactory getSSLFactory() throws Exception {
        ...
        //设置HTTPS SSL 证书信息，跳过证书校验，即信任所有证书请求HTTPS
