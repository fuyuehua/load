package com.rip.load.utils.qrcode;
...
public class QRCodeUtil {
    ...
    *//**
    ...
    public static String encode2Url(String text, String imgPath)throws Exception{
        ...
        String destPath = path + "/1.jpg";
        QRCodeUtil.encode(text, imgPath, destPath, true);
        File file1 = new File(destPath);
        String img = FileUtil.getOnlineUrl("img", file1, true);
        return img;
    }

    public static void main(String[] args) throws Exception {
        // 存放在二维码中的内容
        String text = "陈立是个憨憨单身狗！！咦嘻嘻嘻~";
        // 嵌入二维码的图片路径
        String imgPath = "C:\\Users\\zxh\\Desktop\\desk\\pdf\\1111.jpg";
        // 生成的二维码的路径及名称
        String destPath = "C:\\Users\\zxh\\Desktop\\desk\\pdf\\2.jpg";
        //生成二维码
        QRCodeUtil.encode(text, imgPath, destPath, true);
        // 解析二维码
